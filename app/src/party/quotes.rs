...
const QUOTES: &[(&str, &str)] = &[
    ...
    (
        "Thinking before debugging is extremely important. If you dive into the bug, you tend to fix the local issue in the code, but if you think about the bug first, you often find and correct a higher-level problem.",
        "Rob Pike",
    ),
    // habits:
    (
